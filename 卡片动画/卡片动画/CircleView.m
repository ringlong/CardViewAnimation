...
- (void)animationWithStrokeEnd:(CGFloat)strokeEnd {
    ...
    labelBani.property = [self countLabelAnimatableProperty];
...
- (POPAnimatableProperty *)countLabelAnimatableProperty {
    return [POPAnimatableProperty propertyWithName:@"count" initializer:^(POPMutableAnimatableProperty *prop) {
